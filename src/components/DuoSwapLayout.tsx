...
function WalletConnectionButton({ activateWallet, deactiveWallet, account }: WalletConnectionButtonProps) {
    ...
    return account && etherBalance !== undefined
...
export default function DuoSwapLayout({ children }: { children: Component | Component[] }) {
    ...
    return <Layout className="layout">
        <Header>
            ...
            <WalletConnectionButton activateWallet={activateBrowserWallet} deactiveWallet={deactivate} account={account} />
        </Header>
